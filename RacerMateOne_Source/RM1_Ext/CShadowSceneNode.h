...
#ifndef __C_SHADOW_SCENE_NODE_H_INCLUDED__
#define __C_SHADOW_SCENE_NODE_H_INCLUDED__
...
class CShadowSceneNode : virtual public IBillboardSceneNode
{
public:

	//! constructor
	CShadowSceneNode(ISceneNode* parent=0, ISceneManager* mgr=NULL, s32 id=-1,
