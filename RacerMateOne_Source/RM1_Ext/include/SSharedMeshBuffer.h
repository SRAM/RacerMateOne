...
namespace scene
{
	...
	{
		//! constructor
		SSharedMeshBuffer() : IMeshBuffer(), Vertices(0), ChangedID_Vertex(1), ChangedID_Index(1), 
		...
		//! Get type of Primitive which is stored in this meshbuffer.
		/** \return Primitive type of this buffer. */
		virtual scene::E_PRIMITIVE_TYPE getPrimitiveType() const 
		{
			return PrimitiveType;
		}

		//! Set type of Primitive which is stored in this meshbuffer.
		virtual void setPrimitiveType(scene::E_PRIMITIVE_TYPE primtype)
		{
