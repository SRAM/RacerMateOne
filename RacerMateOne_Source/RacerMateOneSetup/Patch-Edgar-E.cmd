...
@set path=%path%;"C:\Program Files\Microsoft SDKs\Windows\v6.1\Bin";"C:\Program Files\Microsoft SDKs\Windows\v6.1\Bin\msitools\Schemas\MSI"
@set PatchTmp=E:\VSTemp
@set PatchTmpLog=E:\VSTemplog
...
REM ~ rmdir /s /q %PatchTmp%\TargetImage 
REM ~ rmdir /s /q %PatchTmp%\UpgradedImage 
REM ~ rmdir /s /q %PatchTmp%\Tmp 
chdir %PatchDir% 

mkdir Patch 
mkdir Patch\%1 
copy %PatchTmp%\Patch\*.* Patch\%1\*.* 
REM ~ rmdir /s /q %PatchTmp% 
