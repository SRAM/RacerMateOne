...
//from the code project;  MS author gives blanket permission to use at his posting, works real good..
...
{        
    ...
    {            
        ...
        /// <summary>            /// When combined with BIF_NEWDIALOGSTYLE, adds a usage hint to the dialog box in place of the edit box.           
        /// </summary>            
        BIF_UAHINT = 0x0100,            
