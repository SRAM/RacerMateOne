...
//! constructor
CShadowSceneNode::CShadowSceneNode(ISceneNode* parent, ISceneManager* smgr, s32 id,
...
//! pre render event
void CShadowSceneNode::OnRegisterSceneNode()
{
	if (IsVisible)
...
const core::aabbox3d<f32>& CShadowSceneNode::getBoundingBox() const
{
	return BBox;
}
...
void CShadowSceneNode::setSize(const core::dimension2d<f32>& size)
{
	Size = size;
...
video::SMaterial& CShadowSceneNode::getMaterial(u32 i)
{
	return Material;
}
...
u32 CShadowSceneNode::getMaterialCount() const
{
	return 1;
}
...
const core::dimension2d<f32>& CShadowSceneNode::getSize() const
{
	return Size;
}
...
void CShadowSceneNode::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
...
void CShadowSceneNode::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
...
void CShadowSceneNode::setColor(const video::SColor & overallColor)
{
...
void CShadowSceneNode::setColor(const video::SColor & topColor, const video::SColor & bottomColor)
{
...
void CShadowSceneNode::getColor(video::SColor & topColor, video::SColor & bottomColor) const
{
...
void CShadowSceneNode::setUVRect(const core::rect<f32>& uvRect)
{
	UVRect = uvRect;
...
void CShadowSceneNode::getUVRect(core::rect<f32>& uvRect) const
{
	uvRect = UVRect;
}

//! Creates a clone of this scene node and its children.
ISceneNode* CShadowSceneNode::clone(ISceneNode* newParent, ISceneManager* newManager)
{
	if (!newParent)
		newParent = Parent;
	if (!newManager)
	...
	CShadowSceneNode* nb = new CShadowSceneNode(newParent, 
