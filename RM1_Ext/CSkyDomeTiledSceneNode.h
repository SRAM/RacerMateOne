...
#ifndef __C_SKY_DOME_TILED_SCENE_NODE_H_INCLUDED__
#define __C_SKY_DOME_TILED_SCENE_NODE_H_INCLUDED__
...
class CSkyDomeTiledSceneNode : public ISceneNode
{
	public:
		CSkyDomeTiledSceneNode(video::ITexture* texture, video::ITexture* floor, u32 horiRes, u32 vertRes,
			f32 texturePercentage, f32 spherePercentage, f32 radius, f32 tiled, f32 ypos,
			ISceneNode* parent, ISceneManager* smgr, s32 id);
		virtual ~CSkyDomeTiledSceneNode();
