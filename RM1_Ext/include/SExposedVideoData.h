...
{
	SExposedVideoData() {OpenGLWin32.HDc=0; OpenGLWin32.HRc=0; OpenGLWin32.HWnd=0; OpenGLWin32.uflag=0;}
	explicit SExposedVideoData(void* Window, u32 flag = 0) {OpenGLWin32.HDc=0; OpenGLWin32.HRc=0; OpenGLWin32.HWnd=Window; OpenGLWin32.uflag=flag;}
